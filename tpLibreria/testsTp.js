/* libros: lista de objetos
		...
		- editorial: string
		- anio: integer 
		- prestamos: lista de objetos
				- fechaPrestamo: string
				- fechaDevolucion: string
El objeto libro se crea al ingresar un nuevo libro a la libreria, con sus propiedades.
En cada libro, el objeto prestamo se crea cuando un usuario retira el libro, ingresando la fecha de Prestamo.
La fecha de Devolucion se carga cuando el usuario devuelve el libro, .
Caso no contemplado: mas de un ejemplar con igual ISBN, pendiente resolver*/
...
const disponiblePorISBN = obtenerDisponiblePorISBN(listaLibros,1100220033007489)  /*resolver dos ejemplares = ISBN*/
console.log(disponiblePorISBN)
